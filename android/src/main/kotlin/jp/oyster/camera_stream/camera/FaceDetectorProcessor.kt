...
import jp.oyster.camera_stream.models.FaceGraphic
import java.util.*
...
class FaceDetectorProcessor(
    ...
    private val onDetected: ((faces: List<Face>, graphicOverlay: GraphicOverlay) -> Any)? = null,
) :
    ...
    override fun onSuccess(results: List<Face>, graphicOverlay: GraphicOverlay) {
        onDetected?.invoke(results, graphicOverlay)
        for (face in results) {
